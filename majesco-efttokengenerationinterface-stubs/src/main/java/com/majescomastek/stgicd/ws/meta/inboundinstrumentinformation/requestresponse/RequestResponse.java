 ...
 *       &lt;sequence>
 *         &lt;element name="Message" type="{http://com/majescomastek/stgicd/ws/meta/inboundinstrumentinformation/requestresponse}message" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ProcessStatusFlag" type="{http://www.w3.org/2001/XMLSchema}string"/>
    ...
    extends BaseWSVo
{
    ...
    @XmlElement(name = "ProcessStatusFlag", required = true)
