 ...
 *         &lt;element name="totalSkippedObjects" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends BaseVO
{
  ...
  protected Integer totalSkippedObjects;
   ...
   * there is not a <CODE>set</CODE> method for the entityList property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link InstallationEntity }
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the progressLevelDataList property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ProgressLevelData }
   */
  ...
  /**
   * Gets the value of the totalSkippedObjects property.
   *
   * @return possible object is {@link Integer }
   */
  public Integer getTotalSkippedObjects()
  {
    return totalSkippedObjects;
  }

  /**
   * Sets the value of the totalSkippedObjects property.
   *
   * @param value allowed object is {@link Integer }
   */
  public void setTotalSkippedObjects(Integer value)
  {
    this.totalSkippedObjects = value;
  }
