    ...
    extends BaseResponseVO
{
   ...
   * there is not a <CODE>set</CODE> method for the children property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link MenuData }
   */
   ...
   *
   * @return possible object is {@link MenuData }
   */
   ...
   *
   * @param value allowed object is {@link MenuData }
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the menuList property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ResMenuDetails }
   */
