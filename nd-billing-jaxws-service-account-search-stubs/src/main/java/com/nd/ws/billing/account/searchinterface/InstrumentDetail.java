...
@XmlType(name = "instrumentDetail", propOrder = {
    "address1",
    "address2",
    "city",
    "contextId",
    ...
    extends BaseWSVo
{
    ...
    @XmlElement(name = "EftWithdrawalDay")
    protected Long eftWithdrawalDay;
    @XmlElementRef(name = "EmailID", type = JAXBElement.class, required = false)
    protected JAXBElement<String> emailID;
    @XmlElement(name = "InstrumentBankName", required = true)
    protected String instrumentBankName;
    @XmlElement(name = "InstrumentExpiryMonth")
    protected Long instrumentExpiryMonth;
    @XmlElement(name = "InstrumentExpiryYear")
    protected Long instrumentExpiryYear;
    @XmlElement(name = "InstrumentHolderName", required = true)
    protected String instrumentHolderName;
    @XmlElement(name = "InstrumentNo", required = true)
    protected String instrumentNo;
    @XmlElement(name = "InstrumentSecurityCode", required = true)
    protected String instrumentSecurityCode;
    @XmlElement(name = "InstrumentSubType", required = true)
    protected String instrumentSubType;
    @XmlElement(name = "InstrumentTitle", required = true)
    protected String instrumentTitle;
    @XmlElement(name = "InstrumentType", required = true)
