 ...
 * generated in the com.nd.ws.billing.account.searchinterface package. 
...
public class ObjectFactory {
    ...
    private final static QName _Exception_QNAME = new QName("http://com/nd/ws/billing/account/searchinterface", "Exception");
    private final static QName _AccountWorkflowRequest_QNAME = new QName("http://com/nd/ws/billing/account/searchinterface", "accountWorkflowRequest");
    private final static QName _AccountWorkflowResponse_QNAME = new QName("http://com/nd/ws/billing/account/searchinterface", "accountWorkflowResponse");
    private final static QName _ExecuteAccountSearch_QNAME = new QName("http://com/nd/ws/billing/account/searchinterface", "executeAccountSearch");
    private final static QName _ExecuteAccountSearchResponse_QNAME = new QName("http://com/nd/ws/billing/account/searchinterface", "executeAccountSearchResponse");
    private final static QName _PolicyRecurringEftTokenId_QNAME = new QName("", "RecurringEftTokenId");
    ...
    private final static QName _PolicyRequestedDueDay_QNAME = new QName("", "RequestedDueDay");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nd.ws.billing.account.searchinterface
     * 
     */
    ...
    /**
     * Create an instance of {@link ExecuteAccountSearch }
     * 
     */
    public ExecuteAccountSearch createExecuteAccountSearch() {
        return new ExecuteAccountSearch();
    }

    /**
     * Create an instance of {@link ExecuteAccountSearchResponse }
     * 
     */
    public ExecuteAccountSearchResponse createExecuteAccountSearchResponse() {
        return new ExecuteAccountSearchResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/nd/ws/billing/account/searchinterface", name = "Exception")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/nd/ws/billing/account/searchinterface", name = "accountWorkflowRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/nd/ws/billing/account/searchinterface", name = "accountWorkflowResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ExecuteAccountSearch }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://com/nd/ws/billing/account/searchinterface", name = "executeAccountSearch")
    public JAXBElement<ExecuteAccountSearch> createExecuteAccountSearch(ExecuteAccountSearch value) {
        return new JAXBElement<ExecuteAccountSearch>(_ExecuteAccountSearch_QNAME, ExecuteAccountSearch.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ExecuteAccountSearchResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://com/nd/ws/billing/account/searchinterface", name = "executeAccountSearchResponse")
    public JAXBElement<ExecuteAccountSearchResponse> createExecuteAccountSearchResponse(ExecuteAccountSearchResponse value) {
        return new JAXBElement<ExecuteAccountSearchResponse>(_ExecuteAccountSearchResponse_QNAME, ExecuteAccountSearchResponse.class, null, value);
    }
    ...
    public JAXBElement<String> createPolicyRecurringEftTokenId(String value) {
        return new JAXBElement<String>(_PolicyRecurringEftTokenId_QNAME, String.class, Policy.class, value);
    }
    ...
    public JAXBElement<Long> createPolicyRequestedDueDay(Long value) {
        return new JAXBElement<Long>(_PolicyRequestedDueDay_QNAME, Long.class, Policy.class, value);
    }
    ...
    public JAXBElement<String> createEntityRecurringEftTokenId(String value) {
        return new JAXBElement<String>(_PolicyRecurringEftTokenId_QNAME, String.class, Entity.class, value);
    }
    ...
    public JAXBElement<Long> createEntityRequestedDueDay(Long value) {
        return new JAXBElement<Long>(_PolicyRequestedDueDay_QNAME, Long.class, Entity.class, value);
    }
