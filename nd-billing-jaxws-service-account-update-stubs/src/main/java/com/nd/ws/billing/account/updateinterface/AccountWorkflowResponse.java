 ...
 *       &lt;sequence>
 *         &lt;element name="RequestResponse" type="{http://com/nd/ws/billing/account/updateinterface}requestResponse" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "accountWorkflowResponse",
         propOrder = {"requestResponse"})
public class AccountWorkflowResponse extends BaseWSVo
{

    @XmlElement(name = "RequestResponse") protected RequestResponse
        requestResponse;
