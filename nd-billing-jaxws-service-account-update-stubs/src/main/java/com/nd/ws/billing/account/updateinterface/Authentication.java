...
@XmlType(name = "authentication",
         propOrder = {"usernamePasswordAuth"})
public class Authentication
{

    @XmlElement(name = "UsernamePasswordAuth") protected Authentication.UsernamePasswordAuth
     ...
     *     {@link Authentication.UsernamePasswordAuth }
     */
    public void setUsernamePasswordAuth(
        Authentication.UsernamePasswordAuth value
                                       )
    {
    ...
    public static class UsernamePasswordAuth
    {
        ...
        @XmlElement(name = "Username",
                    required = true) protected String username;

        @XmlElement(name = "Password",
                    required = true) protected String password;
