 ...
 *         &lt;element name="EntityAddressList" type="{http://com/nd/ws/billing/account/updateinterface}entityAddress" maxOccurs="unbounded"/>
 *         &lt;element name="EntityType" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="InstrumentDetail" type="{http://com/nd/ws/billing/account/updateinterface}instrumentDetail" minOccurs="0"/>
 ...
 *         &lt;element name="PolicyList" type="{http://com/nd/ws/billing/account/updateinterface}policy" maxOccurs="unbounded"/>
...
@XmlType(name = "entity",
         propOrder = {"billTo", "billType", "doingBusinessAsName",
                      "entityAddressList", "entityType", "instrumentDetail",
                      "invoicingCurrency", "paymentMethod", "policyList",
                      "recurringEftTokenId", "requestedDueDay", "sourceSystem",
                      "sourceSystemEntityCode"})
public class Entity extends BaseWSVo
{

    @XmlElement(name = "BillTo",
                required = true) protected String billTo;

    @XmlElement(name = "BillType",
                required = true) protected String billType;

    @XmlElementRef(name = "DoingBusinessAsName",
                   type = JAXBElement.class,
                   required = false) protected JAXBElement<String>
        doingBusinessAsName;

    @XmlElement(name = "EntityAddressList",
                required = true) protected List<EntityAddress>
        entityAddressList;

    @XmlElement(name = "EntityType",
                required = true) protected String entityType;

    @XmlElement(name = "InstrumentDetail") protected InstrumentDetail
        instrumentDetail;
    ...
    @XmlElement(name = "PaymentMethod",
                required = true) protected String paymentMethod;

    @XmlElement(name = "PolicyList",
                required = true) protected List<Policy> policyList;
    ...
    @XmlElementRef(name = "SourceSystemEntityCode",
                   type = JAXBElement.class,
                   required = false) protected JAXBElement<String>
        sourceSystemEntityCode;
