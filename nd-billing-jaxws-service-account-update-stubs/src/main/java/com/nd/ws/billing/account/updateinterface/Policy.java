 ...
 *         &lt;element name="PolicyEntityList" type="{http://com/nd/ws/billing/account/updateinterface}policyEntity" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "policy",
         propOrder = {"accountNo", "billTo", "billType", "brokerNo", "country",
                      "groupNo", "invoicingCurrency", "lineOfBusiness",
                      "nonRenewalFlag", "nonCancellableFlag",
                      "operatingCompany", "operatingRegion", "paymentMethod",
                      "paymentPlan", "policyEntityList", "policyEffectiveDate",
                      "policyInceptionDate", "policyNo",
                      "previousPolicyEffDate", "previousPolicyNo",
                      "productCode", "programType", "recurringEftTokenId",
                      "renewalCounter", "requestedDueDay", "sdipRatingPlan",
                      "siuFlag", "sourceSystem", "stateCode", "subbrokerNo",
                      "sublineOfBusiness", "underwritingCompany"})
public class Policy extends BaseWSVo
{

    @XmlElement(name = "AccountNo") protected String accountNo;

    @XmlElement(name = "BillTo") protected String billTo;

    @XmlElement(name = "BillType") protected String billType;

    @XmlElement(name = "BrokerNo") protected String brokerNo;

    @XmlElement(name = "Country",
                required = true) protected String country;

    @XmlElement(name = "GroupNo") protected String groupNo;

    @XmlElement(name = "InvoicingCurrency",
                required = true) protected String invoicingCurrency;

    @XmlElement(name = "LineOfBusiness") protected String lineOfBusiness;

    @XmlElement(name = "NonRenewalFlag") protected String nonRenewalFlag;

    @XmlElement(name = "NonCancellableFlag") protected String
        nonCancellableFlag;

    @XmlElement(name = "OperatingCompany") protected String operatingCompany;

    @XmlElement(name = "OperatingRegion") protected String operatingRegion;

    @XmlElement(name = "PaymentMethod") protected String paymentMethod;

    @XmlElement(name = "PaymentPlan") protected String paymentPlan;

    @XmlElement(name = "PolicyEntityList",
                nillable = true) protected List<PolicyEntity> policyEntityList;
    ...
    @XmlElementRef(name = "PolicyInceptionDate",
                   type = JAXBElement.class,
                   required = false) protected JAXBElement<XMLGregorianCalendar>
        policyInceptionDate;

    @XmlElement(name = "PolicyNo",
                required = true) protected String policyNo;

    @XmlElementRef(name = "PreviousPolicyEffDate",
                   type = JAXBElement.class,
                   required = false) protected JAXBElement<XMLGregorianCalendar>
        previousPolicyEffDate;

    @XmlElement(name = "PreviousPolicyNo") protected String previousPolicyNo;

    @XmlElement(name = "ProductCode") protected String productCode;

    @XmlElement(name = "ProgramType") protected String programType;

    @XmlElementRef(name = "RecurringEftTokenId",
                   type = JAXBElement.class,
                   required = false) protected JAXBElement<String>
        recurringEftTokenId;

    @XmlElement(name = "RenewalCounter") protected Long renewalCounter;

    @XmlElementRef(name = "RequestedDueDay",
                   type = JAXBElement.class,
                   required = false) protected JAXBElement<Long>
        requestedDueDay;

    @XmlElement(name = "SDIPRatingPlan") protected String sdipRatingPlan;

    @XmlElement(name = "SiuFlag") protected String siuFlag;

    @XmlElement(name = "SourceSystem",
                required = true) protected String sourceSystem;

    @XmlElement(name = "StateCode") protected String stateCode;

    @XmlElement(name = "SubbrokerNo") protected String subbrokerNo;

    @XmlElement(name = "SublineOfBusiness") protected String sublineOfBusiness;

    @XmlElement(name = "UnderwritingCompany") protected String
        underwritingCompany;
     ...
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     */
    public void setPreviousPolicyEffDate(
        JAXBElement<XMLGregorianCalendar> value
                                        )
    {
