 ...
 *       &lt;sequence>
 *         &lt;element name="EntityAddressList" type="{http://com/nd/ws/billing/account/updateinterface}entityAddress" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "policyEntity",
         propOrder = {"entityAddressList", "doingBusinessAsName", "entityType"})
public class PolicyEntity extends BaseWSVo
{

    @XmlElement(name = "EntityAddressList") protected List<EntityAddress>
        entityAddressList;

    @XmlElement(name = "DoingBusinessAsName") protected String
        doingBusinessAsName;

    @XmlElement(name = "EntityType") protected String entityType;
