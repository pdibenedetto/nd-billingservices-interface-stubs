 ...
 *       &lt;sequence>
 *         &lt;element name="Entity" type="{http://com/nd/ws/billing/account/updateinterface}entity" minOccurs="0"/>
 *         &lt;element name="RequestDate" type="{http://www.w3.org/2001/XMLSchema}date"/>
 *         &lt;element name="RequestSearchDetails" type="{http://com/nd/ws/billing/account/updateinterface}requestSearchDetails" minOccurs="0"/>
...
@XmlType(name = "requestHeader",
         propOrder = {"entity", "requestDate", "requestSearchDetails",
                      "sourceSystemRequestNo"})
public class RequestHeader extends BaseWSVo
{

    @XmlElement(name = "Entity") protected Entity entity;
    ...
    @XmlElement(name = "RequestSearchDetails") protected RequestSearchDetails
        requestSearchDetails;

    @XmlElement(name = "SourceSystemRequestNo",
                required = true) protected String sourceSystemRequestNo;
