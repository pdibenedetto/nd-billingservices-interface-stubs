 ...
 *       &lt;sequence>
 *         &lt;element name="EntityList" type="{http://com/nd/ws/billing/account/updateinterface}entity" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "requestResponse",
         propOrder = {"entityList", "processStatusFlag", "messageList",
                      "requestDate", "sourceSystemRequestNo", "successFlag"})
public class RequestResponse extends BaseWSVo
{

    @XmlElement(name = "EntityList") protected List<Entity> entityList;

    @XmlElement(name = "ProcessStatusFlag") protected String processStatusFlag;

    @XmlElement(name = "MessageList") protected List<Message> messageList;

    @XmlElement(name = "RequestDate")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar requestDate;

    @XmlElement(name = "SourceSystemRequestNo") protected String
        sourceSystemRequestNo;

    @XmlElement(name = "SuccessFlag") protected String successFlag;
