...
@XmlType(name = "requestSearchDetails",
         propOrder = {"fullName", "policyNo", "sourceSystemEntityCode"})
public class RequestSearchDetails extends BaseWSVo
{

    @XmlElement(name = "FullName",
                required = true,
                nillable = true) protected String fullName;

    @XmlElement(name = "PolicyNo",
                required = true,
                nillable = true) protected String policyNo;

    @XmlElement(name = "SourceSystemEntityCode",
                required = true,
                nillable = true) protected String sourceSystemEntityCode;
